...
LDLIBSOPTIONS=-lmingw32 -lSDL2main -lSDL2.dll -lSDL2_image.dll -lSDL2_net.dll
...
${OBJECTDIR}/_ext/5c0/Highscore.o: ../Highscore.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Highscore.o ../Highscore.c

${OBJECTDIR}/_ext/5c0/SDL2_rotozoom.o: ../SDL2_rotozoom.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/SDL2_rotozoom.o ../SDL2_rotozoom.c

${OBJECTDIR}/_ext/5c0/blocks.o: ../blocks.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/blocks.o ../blocks.c

${OBJECTDIR}/_ext/5c0/font.o: ../font.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/font.o ../font.c

${OBJECTDIR}/_ext/5c0/game.o: ../game.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/game.o ../game.c
...
${OBJECTDIR}/_ext/5c0/sprite.o: ../sprite.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/sprite.o ../sprite.c
